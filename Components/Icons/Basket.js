...
const Basket = ({width,height}) => {
  return (
    <>
        <svg id="Layer_1" style={{position:'relative',top:'4px'}} enableBackground="new 0 0 100 100" height={height} viewBox="0 0 100 100" width={width} xmlns="http://www.w3.org/2000/svg">
            <g>
